                            ...
                            <div className="relative rounded-3xl border border-emerald-500/30 bg-neutral-900/90 p-8 shadow-2xl backdrop-blur-xl sm:p-10">
                                ...
                                <div className="text-center mb-8">
                                    ...
                                    <p className="mt-2 text-sm text-neutral-500">
                                        Enter the class code shared by your faculty to join their classroom.
                                    </p>
                                </div>
                                ...
                                {success && (
                                    <div className="mb-6 rounded-xl border border-emerald-500/30 bg-emerald-500/10 px-4 py-3 text-sm text-emerald-400 flex items-center gap-2">
                                        <svg className="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <form onSubmit={handleJoin} className="space-y-6">
                                    <div>
                                        ...
                                        <p className="mt-2 text-xs text-neutral-600">
                                            The code is case-insensitive and usually looks like PROCTO-XXXX
                                        </p>
                                    </div>
                                ...
                                <button
                                    type="button"
                                    className="w-full flex items-center justify-center gap-3 rounded-xl border border-neutral-800 bg-neutral-950/60 px-4 py-3.5 text-sm text-neutral-400 transition-all hover:border-emerald-500/50 hover:text-emerald-400 hover:bg-neutral-900/80"
                                >
                                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
